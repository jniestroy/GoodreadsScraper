...
@click.option("--output_file_suffix",
              ...
              type=str)
@click.pass_context
def single_series(ctx, series_id: str, output_file_suffix: str):
    """Crawl shelves from the "My Books" tab for a user."""
    if not output_file_suffix:
        output_file_suffix = series_id
    click.echo(f"Crawling Goodreads author profile {series_id}")
